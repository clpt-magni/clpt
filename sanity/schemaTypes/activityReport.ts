    ...
    defineField({
      ...
      options: {
        list: [
          ...
          { value: 'awardsAchievements', title: 'AWARDS-ACHIEVEMENTS' },
          { value: 'certificateProgramme', title: 'CERTIFICATE PROGRAMME' },
          { value: 'fdp', title: 'FDP (Faculty Development Programme)' },
          { value: 'guestLecture', title: 'GUEST LECTURE' },
          { value: 'researchGrants', title: 'RESEARCH GRANTS AND SPONSORED RESEARCH' },
          { value: 'ssm', title: 'SSM' },
          { value: 'skillDevelopment', title: 'SKILL DEVELOPMENT PROGRAMME' },
          { value: 'wdh', title: 'WDH' },

          // Cells & Committee Activities
          { value: 'alumniAssociation', title: 'ALUMNI ASSOCIATION ACTIVITIES' },
          { value: 'chess', title: 'CHESS' },
          { value: 'culturalActivities', title: 'CULTURAL ACTIVITIES' },
          { value: 'eagleClub', title: 'EAGLE CLUB' },
          { value: 'extensionActivities', title: 'EXTENSION ACTIVITIES' },
          { value: 'hmapActivities', title: 'HMAP ACTIVITIES' },
          { value: 'hmrActivities', title: 'HMR ACTIVITIES' },
          { value: 'iic', title: 'IIC (Institution\'s Innovation Council)' },
          { value: 'iipec', title: 'IIPEC (INDUSTRY INSTITUTE PARTNERSHIP CELL)' },
          { value: 'ipaLamBranch', title: 'IPA-LAM BRANCH ACTIVITIES' },
          { value: 'iprActivities', title: 'IPR ACTIVITIES (Intellectual Property Rights)' },
          { value: 'iqacActivities', title: 'IQAC ACTIVITIES' },
          { value: 'isporAnuStudent', title: 'ISPOR ANU STUDENT CHAPTER ACTIVITIES' },
          { value: 'isporAmaravathiRegional', title: 'ISPOR INDIA AMARAVATHI REGIONAL CHAPTER ACTIVITIES' },
          { value: 'library', title: 'LIBRARY' },
          { value: 'medicalCamp', title: 'MEDICAL CAMP ACTIVITIES' },
          { value: 'nssUnit1', title: 'NSS UNIT - I ACTIVITIES' },
          { value: 'nssUnit2', title: 'NSS UNIT - II ACTIVITIES' },
          { value: 'orientationProgramme', title: 'ORIENTATION PROGRAMME' },
          { value: 'pmbjakActivities', title: 'PMBJAK ACTIVITIES' },
          { value: 'professionalTraining', title: 'PROFESSIONAL TRAINING FOR TEACHING STAFF' },
          { value: 'sportsActivities', title: 'SPORTS ACTIVITIES' },
          { value: 'womenCellActivities', title: 'WOMEN CELL ACTIVITIES' },
