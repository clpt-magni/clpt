...
export const metadata: Metadata = {
  title: "About Chalapathi Pharmacy College Guntur | CLPT",
  description: "Learn about Chalapathi Institute of Pharmaceutical Sciences, Guntur—its legacy, academic excellence, faculty, infrastructure, and vision.",
  alternates: {
    canonical: "/about",
  },
};
