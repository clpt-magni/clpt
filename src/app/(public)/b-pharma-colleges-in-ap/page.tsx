...
import {
  BookOpen, Calendar, Clock, ArrowLeft, GraduationCap,
  ChevronRight, ClipboardList, CheckCircle2, AlertCircle, HelpCircle
} from "lucide-react";
...
export default function BPharmaAdmissionsPage() {
  ...
  const faqJsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Which entrance exam is required for B. Pharmacy admission in Andhra Pradesh?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "AP EAPCET (formerly known as AP EAMCET) is widely used for admission into numerous pharmacy institutions in Andhra Pradesh."
        }
      },
      {
        "@type": "Question",
        "name": "What subjects are necessary for B. Pharmacy admission?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Generally, students require Physics, Chemistry, and either Mathematics or Biology in their intermediate education."
        }
      },
      {
        "@type": "Question",
        "name": "How long is the B. Pharmacy course?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "B. Pharmacy is a 4-year undergraduate degree programme focusing on pharmaceutical sciences."
        }
      },
      {
        "@type": "Question",
        "name": "Is counseling essential for admission?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "For entrance-based admissions, state government counseling is usually a very important step in seat allocation."
        }
      },
      {
        "@type": "Question",
        "name": "Can students follow higher studies after B. Pharmacy?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes, students may follow M. Pharm, Pharm. D, MBA, and several special programmes after graduation."
        }
      }
    ]
  };
