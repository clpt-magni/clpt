...
export const metadata: Metadata = {
  title: "Contact Chalapathi Pharmacy College Guntur",
  description: "Contact Chalapathi Institute of Pharmaceutical Sciences, Guntur for admissions, course details, campus information, and student support.",
  alternates: {
    canonical: "/contact",
  },
};
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-8">
              {[
                ...
                {
                  title: "Phone Numbers",
                  desc: "Principal: +91 9440101685\nOffice: 0863-2524125",
                  icon: Phone
                },
                {
                  title: "Email Addresses",
                  desc: "Principal: principalclpt@gmail.com\nOffice: officeclpt2@gmail.com",
                  icon: Mail
                }
              ].map((item, i) => (
