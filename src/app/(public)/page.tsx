    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-[650px] flex items-center overflow-hidden bg-primary-dark">
        <div
          ...
          style={{ backgroundImage: "url('https://clpt.s3.ap-south-1.amazonaws.com/college-building.jpg')" }}
        />
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl border-l-[5px] border-secondary pl-8">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/academics">
                <Button size="lg" className="bg-primary hover:bg-primary-dark text-white px-8 py-6 text-lg font-semibold rounded-xl transition-all transform hover:-translate-y-1 shadow-lg">
                  Explore Programs
                </Button>
              </Link>
              <Link href="/admissions">
                <Button size="lg" className="bg-secondary hover:bg-secondary-light text-primary-dark px-8 py-6 text-lg font-semibold rounded-xl transition-all transform hover:-translate-y-1 shadow-lg">
                  Admission Now Open
                </Button>
              </Link>
            </div>
