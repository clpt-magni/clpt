        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl">
            ...
            >
              ...
              <div className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-500">Corporate Relations</div>
            </motion.div>
            ...
            >
              Careers & <span className="text-blue-600 italic">Success</span>
            </motion.h1>
            ...
            >
              Bridging the gap between pharmaceutical education and global industry demands through consistent excellence in placements.
            </motion.p>
