  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
           <ResourceGallery
                sectionKey="audioVisualFacility"
                defaultMainImage="/images/resources/audio-visual/av-head.jpg"
                defaultGalleryImages={["/images/resources/audio-visual/audio.jpg"]}
                mainImageAlt="Audio Visual Room View"
              />
        </div>
      </section>
    </div>
