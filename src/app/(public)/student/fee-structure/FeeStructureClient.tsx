                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-slate-50/75 border-b border-slate-100 text-slate-500">
                      <th className="py-5 px-6 text-xs font-black uppercase tracking-wider">S.No</th>
                      <th className="py-5 px-6 text-xs font-black uppercase tracking-wider">Program / Course</th>
                      ...
                      <th className="py-5 px-6 text-xs font-black uppercase tracking-wider text-right">Tuition Fee (Per Annum)</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-100">
                    {data.programs.map((prog, idx) => (
                      <tr key={idx} className="group hover:bg-slate-50/50 transition-colors">
                        <td className="py-5 px-6 text-sm font-bold text-slate-300 font-poppins">
                        ...
                        <td className="py-5 px-6 text-right">
                          <span className="text-base font-black text-slate-900 font-poppins tracking-tight">
                            ₹ {Number(prog.tuitionFee).toLocaleString('en-IN') || prog.tuitionFee}
                          </span>
                        </td>
                      </tr>
                    ))}
