...
export const metadata: Metadata = {
  title: "Syllabus at Chalapathi Pharmacy College Guntur",
  description: "Download pharmacy course syllabus for B.Pharm, Pharm.D, and M.Pharm programs at Chalapathi Institute of Pharmaceutical Sciences, Guntur.",
  alternates: {
    canonical: "/syllabus",
  },
};
